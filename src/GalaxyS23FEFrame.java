...
public class GalaxyS23FEFrame extends JFrame implements ActionListener {
	...
	GalaxyS23FEFrame() {
		...
		Image GalaxyS23FEScaled = GalaxyS23FEImage.getScaledInstance(300, 500, java.awt.Image.SCALE_SMOOTH);
...
//		white.add(eStar2);
		...
		GalaxyS23FE.setBounds(750, -50, 300, 500); 
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        //add to cart button action
            ...
            CartFrame.setCartInput(12); //passes down index of the phone
        }
