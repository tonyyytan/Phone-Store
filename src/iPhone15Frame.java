...
public class iPhone15Frame extends JFrame implements ActionListener {
	...
	iPhone15Frame() {
		...
		ImageIcon iPhone15Icon = new ImageIcon("images/iPhone 15.png");
		Image iPhone15Image = iPhone15Icon.getImage();
		Image iPhone15Scaled = iPhone15Image.getScaledInstance(300, 500, java.awt.Image.SCALE_SMOOTH);
		ImageIcon iPhone15Final = new ImageIcon(iPhone15Scaled); 
		...
		JLabel iPhone15 = new JLabel(iPhone15Final);
		iPhone15.setBounds(750, -50, 300, 500); 
		white.add(iPhone15);
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        //add to cart button action
            ...
            CartFrame.setCartInput(15);  //passes down index of the phone
        }
