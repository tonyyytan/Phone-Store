...
public class GalaxyA23Frame extends JFrame implements ActionListener {
	...
	GalaxyA23Frame() {
		...
		ImageIcon GalaxyA23Icon = new ImageIcon("images/Galaxy A23.png");
		Image GalaxyA23Image = GalaxyA23Icon.getImage();
		Image GalaxyA23Scaled = GalaxyA23Image.getScaledInstance(300, 500, java.awt.Image.SCALE_SMOOTH);
		ImageIcon GalaxyA23Final = new ImageIcon(GalaxyA23Scaled); 
...
//		white.add(eStar2);
		...
		JLabel GalaxyA15 = new JLabel(GalaxyA23Final);
