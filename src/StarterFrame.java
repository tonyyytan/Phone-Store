...
public class StarterFrame extends JFrame implements ActionListener {
	...
	private static final String[] BUTTON_TEXTS = {"home", "education", "survey"};
	  ...
	  public StarterFrame() {
	    ...
	    JLabel intro = new JLabel("Shop Starters:");
	    intro.setBounds(50, 20, 500, 30);
	    intro.setFont(new Font("Canva Sans", Font.BOLD, 25));
	    white.add(intro);
	
	    JLabel intro2 = new JLabel("Quality and Affordability.");
	    ...
	    String[] imagePaths = {
            "images/Moto G Play.png", "images/TCL 20S.png", "images/Galaxy A15.png", "images/Moto G Power.png",
            "images/Galaxy A23.png", "images/blank.jpg", "images/blank.jpg", "images/blank.jpg",
        ...
        String[][] phoneArrayIndex = {
            {"Moto G Play", "TCL 20S", "Galaxy A15 5G", "Moto G Power"},
            {"Galaxy A23", "", "", ""},
            {"", "", "", ""},
            {"", "", "", ""},
            {"", "", "", ""}
	...
	public void actionPerformed(ActionEvent event) {
        ...
        //learn more button actions
        	...
        	setVisible(false);
        	GalaxyA23Frame GalaxyA23 = new GalaxyA23Frame();
        }
