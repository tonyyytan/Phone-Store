...
public class Pixel8ProFrame extends JFrame implements ActionListener {
	...
	Pixel8ProFrame() {
		...
		ImageIcon Pixel8ProIcon = new ImageIcon("images/Pixel 8 Pro.png");
		Image Pixel8ProImage = Pixel8ProIcon.getImage();
		Image Pixel8ProScaled = Pixel8ProImage.getScaledInstance(300, 500, java.awt.Image.SCALE_SMOOTH);
		ImageIcon Pixel8ProFinal = new ImageIcon(Pixel8ProScaled); 
...
//		white.add(eStar2);
		...
		JLabel Pixel8Pro = new JLabel(Pixel8ProFinal);
		Pixel8Pro.setBounds(750, -50, 300, 500); 
		white.add(Pixel8Pro);
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        //add to cart button action
            ...
            CartFrame.setCartInput(10); //passes down index of the phone
        }
