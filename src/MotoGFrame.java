...
public class MotoGFrame extends JFrame implements ActionListener {
	...
	MotoGFrame() {
		...
		ImageIcon MotoGIcon = new ImageIcon("images/Moto G.png");
		Image MotoGImage = MotoGIcon.getImage();
		Image MotoGScaled = MotoGImage.getScaledInstance(300, 500, java.awt.Image.SCALE_SMOOTH);
		ImageIcon MotoGFinal = new ImageIcon(MotoGScaled); 
		...
		JLabel MotoG = new JLabel(MotoGFinal);
		MotoG.setBounds(750, -50, 300, 500); 
		white.add(MotoG);
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        //add to cart button action
            ...
            CartFrame.setCartInput(8); //passes down the phone index
        }
