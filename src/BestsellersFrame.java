...
public class BestsellersFrame extends JFrame implements ActionListener {
    //declare Scroll pane
    JPanel white;
    JScrollPane scroll;
    //declare widgets
    ...
    public BestsellersFrame() {
        ...
        JLabel intro = new JLabel("Shop Bestsellers:");
        intro.setBounds(50, 20, 500, 30);
        intro.setFont(new Font("Canva Sans", Font.BOLD, 25));
        white.add(intro);

        JLabel intro2 = new JLabel("What's hot, right now.");
