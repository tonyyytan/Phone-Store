...
public class MidRangeFrame extends JFrame implements ActionListener {
	//declare Scroll pane
	JPanel white;
	JScrollPane scroll;
	//declare widgets
	...
	private static final String[] BUTTON_TEXTS = {"home", "education", "survey"};
	  ...
	  public MidRangeFrame() {
	      ...
	      String[] imagePaths = {
	        "images/Pixel 7A.png", "images/iPhone SE.png", "images/Galaxy A35.png", "images/Moto G.png",
	        "images/Nord N30.png", "images/blank.jpg", "images/blank.jpg", "images/blank.jpg",
	        "images/blank.jpg", "images/blank.jpg", "images/blank.jpg", "images/blank.jpg",
	        "images/blank.jpg", "images/blank.jpg", "images/blank.jpg", "images/blank.jpg",
	        "images/blank.jpg", "images/blank.jpg", "images/blank.jpg", "images/blank.jpg"
	      };

        //fill imageArray with JLabels that hold the imagess
        ...
        String[][] phoneArrayIndex = {
            {"Pixel 7A", "iPhone SE (2022)", "Galaxy A35", "Moto G 5G"},
            {"Nord N30", "", "", ""},
            {"", "", "", ""},
            {"", "", "", ""},
            {"", "", "", ""}
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        //learn more button actions
        	...
        	setVisible(false);
        	NordN30Frame NordN30 = new NordN30Frame();
        }
