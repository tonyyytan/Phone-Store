...
public class LuxuryFrame extends JFrame implements ActionListener {
	//declare Scroll pane
	JPanel white;
	JScrollPane scroll;
	//declare widgets
    ...
    public LuxuryFrame() {
        ...
        JLabel intro = new JLabel("Shop Luxury:");
        intro.setBounds(50, 20, 500, 30);
        intro.setFont(new Font("Canva Sans", Font.BOLD, 25));
        white.add(intro);

        JLabel intro2 = new JLabel("The Elite. The Best of the Best.");
        ...
        String[] imagePaths = {
            "images/iPhone 15.png", "images/Galaxy S24 Ultra.png", "images/Galaxy Z Fold 5.png", "images/OnePlus 12.png",
            "images/iPhone 15 Max Pro.png", "images/blank.jpg", "images/blank.jpg", "images/blank.jpg",
        ...
        String[][] phoneArrayIndex = {
            {"iPhone 15", "Galaxy S24 Ultra", "Galaxy Z Fold 5", "OnePlus 12"},
            {"iPhone 15 Max Pro", "", "", ""},
            {"", "", "", ""},
            {"", "", "", ""},
            {"", "", "", ""}
        ...
        String[][] priceArrayIndex = {
            {"$1129.99", "$1799.99", "$2399.99", "$1199.99"},
            {"$1749.99", "", "", ""},
            {"", "", "", ""},
            {"", "", "", ""},
            {"", "", "", ""}
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        //learn more button actions
        	...
        	setVisible(false);
        	iPhone15MaxProFrame iPhone15MaxPro = new iPhone15MaxProFrame();
        }
