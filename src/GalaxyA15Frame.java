...
public class GalaxyA15Frame extends JFrame implements ActionListener {
	...
	GalaxyA15Frame() {
		...
		ImageIcon GalaxyA15Icon = new ImageIcon("images/Galaxy A15.png");
		Image GalaxyA15Image = GalaxyA15Icon.getImage();
		Image GalaxyA15Scaled = GalaxyA15Image.getScaledInstance(300, 500, java.awt.Image.SCALE_SMOOTH);
		ImageIcon GalaxyA15Final = new ImageIcon(GalaxyA15Scaled); 
		...
		JLabel GalaxyA15 = new JLabel(GalaxyA15Final);
		GalaxyA15.setBounds(750, -50, 300, 500); 
		white.add(GalaxyA15);
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        //add to cart button action
            ...
            CartFrame.setCartInput(2); //passes index of phone
        }
    }
}
