...
public class NordN30Frame extends JFrame implements ActionListener {
	...
	NordN30Frame() {
		...
		ImageIcon NordN30Icon = new ImageIcon("images/Nord N30.png");
		Image NordN30Image = NordN30Icon.getImage();
		Image NordN30Scaled = NordN30Image.getScaledInstance(300, 500, java.awt.Image.SCALE_SMOOTH);
		ImageIcon NordN30Final = new ImageIcon(NordN30Scaled); 
		...
		JLabel NordN30 = new JLabel(NordN30Final);
		NordN30.setBounds(750, -50, 300, 500); 
		white.add(NordN30);
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        //add to cart button action
            ...
            CartFrame.setCartInput(9); //passes down phone index 
        }
