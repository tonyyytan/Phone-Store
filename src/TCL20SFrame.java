...
public class TCL20SFrame extends JFrame implements ActionListener {
	...
	TCL20SFrame() {
		...
		ImageIcon TCL20SIcon = new ImageIcon("images/TCL 20S.png");
		Image TCL20SImage = TCL20SIcon.getImage();
		Image TCL20SScaled = TCL20SImage.getScaledInstance(300, 500, java.awt.Image.SCALE_SMOOTH);
		ImageIcon TCL20SFinal = new ImageIcon(TCL20SScaled); 
		...
		JLabel TCL20S = new JLabel(TCL20SFinal);
		TCL20S.setBounds(750, -50, 300, 500); 
		white.add(TCL20S);
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        //add to cart button action
            ...
            CartFrame.setCartInput(1); //passes index of the phone
        }
