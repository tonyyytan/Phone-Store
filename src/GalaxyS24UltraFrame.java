...
public class GalaxyS24UltraFrame extends JFrame implements ActionListener {
	...
	GalaxyS24UltraFrame() {
		...
		ImageIcon GalaxyS24UltraIcon = new ImageIcon("images/Galaxy S24 Ultra.png");
		Image GalaxyS24UltraImage = GalaxyS24UltraIcon.getImage();
		Image GalaxyS24UltraScaled = GalaxyS24UltraImage.getScaledInstance(300, 500, java.awt.Image.SCALE_SMOOTH);
		ImageIcon GalaxyS24UltraFinal = new ImageIcon(GalaxyS24UltraScaled); 
...
//		white.add(eStar2);
		...
		JLabel GalaxyS24Ultra = new JLabel(GalaxyS24UltraFinal);
		GalaxyS24Ultra.setBounds(750, -50, 300, 500); 
		white.add(GalaxyS24Ultra);
		...
		//model name
		model.setText("Galaxy S24 Ultra");
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        //add to cart button action
            ...
            CartFrame.setCartInput(16); //passes down index of the phone
        }
