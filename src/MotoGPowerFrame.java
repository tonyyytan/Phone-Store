...
public class MotoGPowerFrame extends JFrame implements ActionListener {
	...
	MotoGPowerFrame() {
		...
		ImageIcon MotoGPowerIcon = new ImageIcon("images/Moto G Power.png");
		Image MotoGPowerImage = MotoGPowerIcon.getImage();
		Image MotoGPowerScaled = MotoGPowerImage.getScaledInstance(300, 500, java.awt.Image.SCALE_SMOOTH);
		ImageIcon MotoGPowerFinal = new ImageIcon(MotoGPowerScaled); 
		...
		JLabel MotoGPower = new JLabel(MotoGPowerFinal);
		MotoGPower.setBounds(750, -50, 300, 500); 
		white.add(MotoGPower);
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        //add to cart button action
            ...
            CartFrame.setCartInput(3); //passes down the index of the phone
        }
