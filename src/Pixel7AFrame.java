...
public class Pixel7AFrame extends JFrame implements ActionListener {
	...
	Pixel7AFrame() {
		...
		ImageIcon Pixel7AIcon = new ImageIcon("images/Pixel 7A.png");
		Image Pixel7AImage = Pixel7AIcon.getImage();
		Image Pixel7AScaled = Pixel7AImage.getScaledInstance(300, 500, java.awt.Image.SCALE_SMOOTH);
		ImageIcon Pixel7AFinal = new ImageIcon(Pixel7AScaled); 
		...
		JLabel Pixel7A = new JLabel(Pixel7AFinal);
		Pixel7A.setBounds(750, -50, 300, 500); 
		white.add(Pixel7A);
