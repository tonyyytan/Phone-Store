...
public class MotoGPlayFrame extends JFrame implements ActionListener {
	...
	MotoGPlayFrame() {
		...
		ImageIcon MotoGPlayIcon = new ImageIcon("images/Moto GPlay.png");
		Image MotoGPlayImage = MotoGPlayIcon.getImage();
		Image MotoGPlayScaled = MotoGPlayImage.getScaledInstance(300, 500, java.awt.Image.SCALE_SMOOTH);
		ImageIcon MotoGPlayFinal = new ImageIcon(MotoGPlayScaled); 
		...
		JLabel MotoGPlay = new JLabel(MotoGPlayFinal);
		MotoGPlay.setBounds(750, -50, 300, 500); 
		white.add(MotoGPlay);
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        //add to cart button action
            ...
            CartFrame.setCartInput(0); //passes down index of phone
        }
