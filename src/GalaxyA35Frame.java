...
public class GalaxyA35Frame extends JFrame implements ActionListener {
	...
	GalaxyA35Frame() {
		...
		ImageIcon GalaxyA35Icon = new ImageIcon("images/Galaxy A35.png");
		Image GalaxyA35Image = GalaxyA35Icon.getImage();
		Image GalaxyA35Scaled = GalaxyA35Image.getScaledInstance(300, 500, java.awt.Image.SCALE_SMOOTH);
		ImageIcon GalaxyA35Final = new ImageIcon(GalaxyA35Scaled); 
		...
		JLabel GalaxyA35 = new JLabel(GalaxyA35Final);
		GalaxyA35.setBounds(750, -50, 300, 500); 
		white.add(GalaxyA35);
