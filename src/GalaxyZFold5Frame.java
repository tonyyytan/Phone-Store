...
public class GalaxyZFold5Frame extends JFrame implements ActionListener {
	...
	GalaxyZFold5Frame() {
		...
		Image GalaxyZFold5Scaled = GalaxyZFold5Image.getScaledInstance(300, 500, java.awt.Image.SCALE_SMOOTH);
...
//		white.add(eStar2);
		...
		GalaxyZFold5.setBounds(750, -50, 300, 500); 
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        //add to cart button action
            ...
            CartFrame.setCartInput(17); //passes down the index of the phone
        }
