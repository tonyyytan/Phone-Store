...
public class iPhone13Frame extends JFrame implements ActionListener {
	...
	iPhone13Frame() {
		...
		ImageIcon iPhone13Icon = new ImageIcon("images/iPhone 13.png");
		Image iPhone13Image = iPhone13Icon.getImage();
		Image iPhone13Scaled = iPhone13Image.getScaledInstance(300, 500, java.awt.Image.SCALE_SMOOTH);
		ImageIcon iPhone13Final = new ImageIcon(iPhone13Scaled); 
		...
		JLabel iPhone13 = new JLabel(iPhone13Final);
		iPhone13.setBounds(750, -50, 300, 500); 
		white.add(iPhone13);
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        //add to cart button action
            ...
            CartFrame.setCartInput(11); //passes down index of the phone
        }
