...
public class iPhoneSEFrame extends JFrame implements ActionListener {
	...
	iPhoneSEFrame() {
		...
		Image iPhoneSEScaled = iPhoneSEImage.getScaledInstance(300, 500, java.awt.Image.SCALE_SMOOTH);
...
//		white.add(eStar2);
		...
		iPhoneSE.setBounds(750, -50, 300, 500); 
		white.add(iPhoneSE);
