...
public class iPhone15MaxProFrame extends JFrame implements ActionListener {
	...
	iPhone15MaxProFrame() {
		...
		ImageIcon iPhone15MaxProIcon = new ImageIcon("images/iPhone 15 Max Pro.png");
		Image iPhone15MaxProImage = iPhone15MaxProIcon.getImage();
		Image iPhone15MaxProScaled = iPhone15MaxProImage.getScaledInstance(300, 500, java.awt.Image.SCALE_SMOOTH);
		ImageIcon iPhone15MaxProFinal = new ImageIcon(iPhone15MaxProScaled); 
		...
		JLabel[] filledStars = new JLabel[3];
		...
		JLabel iPhone15MaxPro = new JLabel(iPhone15MaxProFinal);
		iPhone15MaxPro.setBounds(750, -50, 300, 500); 
		white.add(iPhone15MaxPro);
		...
		//model name
		model.setText("iPhone 15 Max Pro");
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        //add to cart button action
            ...
            CartFrame.setCartInput(19); //passes down the index of the phone
        }
