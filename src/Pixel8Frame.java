...
public class Pixel8Frame extends JFrame implements ActionListener {
	...
	Pixel8Frame() {
		...
		ImageIcon Pixel8Icon = new ImageIcon("images/Pixel 8.png");
		Image Pixel8Image = Pixel8Icon.getImage();
		Image Pixel8Scaled = Pixel8Image.getScaledInstance(300, 500, java.awt.Image.SCALE_SMOOTH);
		ImageIcon Pixel8Final = new ImageIcon(Pixel8Scaled); 
		...
		JLabel Pixel8 = new JLabel(Pixel8Final);
		Pixel8.setBounds(750, -50, 300, 500); 
		white.add(Pixel8);
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        //add to cart button action
            ...
            CartFrame.setCartInput(13); //passes down index of the phone
        }
